...
class List extends React.Component {
  constructor(props){
    ...
    const datas =  [
      {key: '1', id: 'John2', phone: 'xxxx', buyName: 'xxxx', buyType: 'xxxx', statue: 'statue', integral: 'integral',creatueTime: 'creatueTime',action: 'action'}, 
      {key: '2', id: 'John2', phone: 'xxxx', buyName: 'xxxx', buyType: 'xxxx', statue: 'statue', integral: 'integral',creatueTime: 'creatueTime',action: 'action'}, 
      {key: '3', id: 'John2', phone: 'xxxx', buyName: 'xxxx', buyType: 'xxxx', statue: 'statue', integral: 'integral',creatueTime: 'creatueTime',action: 'action'}, 
