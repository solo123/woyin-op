  ...
  constructor(props){
    ...
    const tableData = {
      columns: [
        ...
        {title: '操作', dataIndex: 'find', key: 'find', render: (texts, record) => (<a href="javascript:void(0)" onClick={()=> {this.onHangeDetails(texts, record)}}>批量扣除积分</a>)},
...
onHangeDetails = (texts, record) => {
  ...
  this.props.dispatch(routerRedux.push({
    pathname: '/merchant/allrectpoint'
  }));
}
