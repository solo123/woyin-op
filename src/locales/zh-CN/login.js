export default {
  ...
  'app.login.message-invalid-credentials': '账户或密码错误！！ ( • ̀ω•́ )✧',
  ...
  'app.ResetPaswrod.name': '用户名',
  'app.ResetPaswrod.emails': '绑定的邮箱',
  'app.ResetPaswrod.submitting': '找回密码',
  'app.findPwasswordEmial': '邮箱找回密码',
  'app.ResetPaswrod.validateCode': '校验码',
  'app.ResetPaswrod.newsPassword': '新密码',
  'app.ResetPaswrod.newsPasswordTwo': '确认密码',
  'app.findPwasswordMobile': '手机找回密码',
  'app.findPwasswordMobile.mobile': '绑定的手机号',
  'app.ResetPaswrod.sendEmails': '发送校验码',
  'app.ResetPaswrod.validateCode.Message': '校验码错误',
  'app.rturen.logo': '返回登录页'
};
